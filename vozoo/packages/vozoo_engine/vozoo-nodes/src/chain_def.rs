    ...
    vec![
        ChainDef {
            ...
            nodes: vec![
                ...
                // Core + Character
                NodeDef { node_type: "pitch_shift".into(), params: serde_json::json!({"semitones": -5.0}) },
                NodeDef { node_type: "formant_shift".into(), params: serde_json::json!({"shift_factor": 0.8}) },
                // Post Processing
        ...
        ChainDef {
            ...
            nodes: vec![
                ...
                NodeDef { node_type: "noise_reduction".into(), params: serde_json::json!({}) },
                NodeDef { node_type: "normalizer".into(), params: serde_json::json!({"target_rms": 0.2}) },
                NodeDef { node_type: "pitch_shift".into(), params: serde_json::json!({"semitones": 6.0}) },
                NodeDef { node_type: "formant_shift".into(), params: serde_json::json!({"shift_factor": 1.25}) },
                NodeDef { node_type: "loudness_norm".into(), params: serde_json::json!({"target_lufs": -14.0}) },
                NodeDef { node_type: "lookahead_limiter".into(), params: serde_json::json!({"ceiling_db": -1.0}) },
            ],
        },
        ChainDef {
            ...
            nodes: vec![
                ...
                NodeDef { node_type: "noise_reduction".into(), params: serde_json::json!({}) },
                NodeDef { node_type: "normalizer".into(), params: serde_json::json!({"target_rms": 0.2}) },
                NodeDef { node_type: "ring_mod".into(), params: serde_json::json!({"mod_freq": 50.0, "quantize_steps": 8.0, "mix": 0.8}) },
                NodeDef { node_type: "convolution_reverb".into(), params: serde_json::json!({"dry_wet": 0.15}) },
                NodeDef { node_type: "loudness_norm".into(), params: serde_json::json!({"target_lufs": -14.0}) },
                NodeDef { node_type: "lookahead_limiter".into(), params: serde_json::json!({"ceiling_db": -1.0}) },
            ],
        },
        ...
        ChainDef {
            ...
            nodes: vec![
                ...
                NodeDef { node_type: "noise_reduction".into(), params: serde_json::json!({}) },
                NodeDef { node_type: "normalizer".into(), params: serde_json::json!({"target_rms": 0.2}) },
                NodeDef { node_type: "pitch_shift".into(), params: serde_json::json!({"semitones": -8.0}) },
                NodeDef { node_type: "formant_shift".into(), params: serde_json::json!({"shift_factor": 0.72}) },
                NodeDef { node_type: "compressor".into(), params: serde_json::json!({"threshold_db": -26.0, "ratio": 6.0}) },
                NodeDef { node_type: "loudness_norm".into(), params: serde_json::json!({"target_lufs": -14.0}) },
                NodeDef { node_type: "lookahead_limiter".into(), params: serde_json::json!({"ceiling_db": -1.0}) },
            ],
        },
        ChainDef {
            ...
            nodes: vec![
                ...
                NodeDef { node_type: "noise_reduction".into(), params: serde_json::json!({}) },
                NodeDef { node_type: "normalizer".into(), params: serde_json::json!({"target_rms": 0.2}) },
                NodeDef { node_type: "pitch_shift".into(), params: serde_json::json!({"semitones": 11.0}) },
                NodeDef { node_type: "formant_shift".into(), params: serde_json::json!({"shift_factor": 1.38}) },
                NodeDef { node_type: "chorus".into(), params: serde_json::json!({"delay_ms": 18.0, "depth_ms": 2.5, "rate_hz": 2.4, "mix": 0.18}) },
                NodeDef { node_type: "loudness_norm".into(), params: serde_json::json!({"target_lufs": -14.0}) },
                NodeDef { node_type: "lookahead_limiter".into(), params: serde_json::json!({"ceiling_db": -1.0}) },
            ],
        },
        ChainDef {
            ...
            nodes: vec![
                ...
                NodeDef { node_type: "noise_reduction".into(), params: serde_json::json!({}) },
                NodeDef { node_type: "normalizer".into(), params: serde_json::json!({"target_rms": 0.2}) },
                NodeDef { node_type: "highpass".into(), params: serde_json::json!({"freq": 420.0, "q": 0.707}) },
                NodeDef { node_type: "lowpass".into(), params: serde_json::json!({"freq": 3200.0, "q": 0.707}) },
                NodeDef { node_type: "ring_mod".into(), params: serde_json::json!({"mod_freq": 32.0, "quantize_steps": 18.0, "mix": 0.28}) },
                NodeDef { node_type: "compressor".into(), params: serde_json::json!({"threshold_db": -24.0, "ratio": 5.0}) },
                NodeDef { node_type: "loudness_norm".into(), params: serde_json::json!({"target_lufs": -16.0}) },
                NodeDef { node_type: "lookahead_limiter".into(), params: serde_json::json!({"ceiling_db": -1.0}) },
            ],
        },
        ChainDef {
            ...
            nodes: vec![
                ...
                NodeDef { node_type: "noise_reduction".into(), params: serde_json::json!({}) },
                NodeDef { node_type: "normalizer".into(), params: serde_json::json!({"target_rms": 0.2}) },
                NodeDef { node_type: "convolution_reverb".into(), params: serde_json::json!({"room_size": 1.45, "damping": 0.35, "dry_wet": 0.58}) },
                NodeDef { node_type: "deesser".into(), params: serde_json::json!({"frequency": 5200.0, "threshold_db": -18.0, "ratio": 4.0}) },
                NodeDef { node_type: "loudness_norm".into(), params: serde_json::json!({"target_lufs": -14.0}) },
                NodeDef { node_type: "lookahead_limiter".into(), params: serde_json::json!({"ceiling_db": -1.0}) },
            ],
        },
